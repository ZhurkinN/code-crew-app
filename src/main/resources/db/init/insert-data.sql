...
VALUES ('alex@mail.ru', 'Gordon', 'Alonso', '123', 'I am Gordon', ARRAY ['https://github.com/Alonso', 'https://inst/Alonso']),
       ('weiber@mail.ru', 'Loren', 'Wisen', '123', 'I am Loren', ARRAY ['https://github.com/Wisen', 'https://inst/Wisen']),
       ('mercen@yandex.ru', 'Karl', 'Lieben', '123', 'I am Karl', ARRAY ['https://github.com/Lieben', 'https://inst/Lieben']),
       ('kulich@anser.ru', 'Weiner', 'Arxz', '123', 'I am Weiner', ARRAY ['https://github.com/Arxz', 'https://inst/Arxz']),
       ('reter@mail.ru', 'Isopre', 'Wertin', '123', 'I am Isopre', ARRAY ['https://github.com/Wertin', 'https://inst/Isopre']),
       ('kio@mail.ru', 'Gordon', 'Maxs', '123', 'I am Gordon', ARRAY ['https://github.com/Maxs', 'https://inst/alex']),
       ('alex@yandex.ru', 'Kloner', 'Leiner', '123', 'I am Kloner', ARRAY ['https://github.com/Leiner', 'https://inst/Leiner']),
       ('loire@mail.ru', 'Lioner', 'Wiseben', '123', 'I am Lioner', ARRAY ['https://github.com/Wiseben', 'https://inst/Wiseben']),
       ('wesber@yandex.ru', 'Alones', 'Lionel', '123', 'I am Alones', ARRAY ['https://github.com/Lionel', 'https://inst/Lionel']);

insert into resume(description, direction, user_id, skills)
values ('Hey, i want to work backend dev', 'BACKEND', 1, ARRAY ['Java', 'Spring', 'Micronaut', 'Docker', 'Postgres', 'REST']),
       ('Hey, i want to work frontend dev', 'FRONTEND', 2, ARRAY ['JavaScript', 'Next', 'React', 'Node', 'Postgres', 'REST']),
...
insert into position_request(resume_id, position_id, status, cover_letter)
VALUES (1, 1, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде'),
       (8, 2, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде'),
       (3, 3, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде'),
       (7, 4, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде'),
       (8, 5, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде'),
       (3, 6, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде'),
       (5, 7, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде'),
       (7, 8, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде'),
       (3, 9, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде'),
       (7, 10, 'IN_CONSIDERATION', 'Очень хочу работать в вашей команде');

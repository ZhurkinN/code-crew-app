...
insert into participants(id, description, direction_id, team_id, user_id)
values (1, 'Backend-разработчик', 1, 4, 2),
       (2, 'QA Engineer', 3, 4, 3),

       (3, 'Frontend-разработчик', 2, 1, 6),
       (4, 'Backend-разработчик', 1, 1, 2),
       (5, 'QA Engineer', 3, 1, 3),
       (6, 'ML-разработчик', 5, 1, 9),
       (7, 'Data science разработчик', 4, 1, 4),

       (8, 'QA Engineer', 3, 2, 3),
       (9, 'Frontend-разработчик', 2, 2, 6),
       (10, 'Backend-разработчик', 1, 2, 7),

       (11, 'Frontend-разработчик', 2, 3, 6),
       (12, 'Backend-разработчик', 1, 3, 2),
       (13, 'QA Engineer', 3, 3, 3),
       (14, 'ML-разработчик', 5, 3, 9),

       (15, 'Frontend-разработчик', 2, 5, 6),
       (16, 'Backend-разработчик', 1, 5, 2),
       (17, 'QA Engineer', 3, 5, 3),
       (18, 'ML-разработчик', 5, 5, 9);
...
insert into team_request(id, resume_id, vacancy_id)
values (1, 2, 1),
       (2, 6, 3),
       (3, 8, 5),
       (4, 9, 6),

...
public interface ErrorDisplayMessageKeeper {
    ...
    String INACCESSIBLE_RESUME_ACTION = "User with email = %s tried to perform inaccessible (He is not owner) action with resume (resume with id = %d).";
    String INACCESSIBLE_PROJECT_ACTION = "User with email = %s tried to perform inaccessible (He is not leader) action with project (project with id = %d).";
    String INACCESSIBLE_POSITION_ACTION = "User with email = %s tried to perform inaccessible (He is not leader) action with position (position with id = %d).";
    String USER_ALREADY_IN_PROJECT = "User with email = %s is already in project (position with id = %d). He can't join or be invited here.";
